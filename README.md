...
Demo to show how to add tracing with [OpnTelemetry](https://opentelemetry.io/) in a 
[FastAPI](https://fastapi.tiangolo.com/) python project and send/show traces in 
[Grafana Tempo](https://grafana.com/oss/tempo/) using auto-instrumentation feature
...
LoggingInstrumentor().instrument() # logging auto-instrumentation
FastAPIInstrumentor.instrument_app(app, tracer_provider=tracer) # FastAPI auto-instrumentation
```
